...
export const SCROLLABLE_JSX = "scrollable_jsx";
...
export const GET_SUBSCRIPTIONS_URL = `https://youtube.googleapis.com/youtube/v3/subscriptions?part=snippet,contentDetails&mine=true&maxResults=50&fields=items(id,contentDetails(totalItemCount),snippet(title,channelId,thumbnails(high(url)))),nextPageToken&key=${process.env.REACT_APP_API_KEY}`;
